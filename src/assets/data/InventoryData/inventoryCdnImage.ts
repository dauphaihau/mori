let inventory = [
  {
    ...
    price: 2500,
    colors: ['#7A6255'],
    images: ['/product/casket-autumn-oak-ardwood_imxhpl.png'],
  ...
  {
    categories: ['casket'],
    name: 'Clarksburg – Wooden American Casket Coffin',
    price: 7575,
    colors: ['#7A6255'],
    images: ['/product/casket-clarksburg_oyptdh.png'],
    description: 'With a special maple wood veneer, the Clarksburg comes with elegant inlay panelling to the sides and ends, a soft brushed-velvet interior and matching upholstered hinged casket lid .',
    brand: 'Batesville',
    quantity: 0,
    rating: 5,
    createdAt: '2022-11-13T14:55:06.641+00:00',
    bestSelling: false
  },
  {
    categories: ['casket'],
    ...
    price: 2100,
    salePrice: 2000,
    images: ['/product/casket-trinity-oak_swipzi.png'],
    colors: ['#7A6255'],
  ...
  },
  {
    ...
    price: 2845,
    salePrice: 2600,
    images: ['/product/casket-white-chased_-solid-wood_gp9jh3.png'],
    colors: ['#cfcdcb'],
  ...
  },
  {
    ...
    salePrice: 2100,
    colors: ['#7A6255'],
    images: ['/product/casket-last-supper-hardwood_ccedyk.png'],
  ...
  },
  {
    ...
    salePrice: 520,
    colors: ['#7A6255'],
    images: ['/product/coffin-willow-pod_gwymz9.png'],
  ...
  },
  {
    ...
    name: 'Shannon',
    price: 895,
    images: ['/product/coffin-traditional-shannon_uuwxlu.png'],
    colors: ['#B99374'],
    description: 'A clear-finished oak coffin with bridge panels on the sides and ends. The Shannon follows a classic Irish coffin design and is shown here with brass effect metal bar handles. It is lined with a rich satin interior, available in a choice of colours .',
    brand: 'Astral',
    quantity: 10,
    rating: 5,
    createdAt: '2022-11-01T14:55:06.641+00:00',
    bestSelling: true
  },
  {
    categories: ['natural material coffin'],
    name: 'Oval Walnut Tree Coffin',
    price: 800,
    images: ['product/coffin-modern-walnutt_findy8.png'],
    colors: ['#B99374'],
  ...
  {
    categories: ['natural material coffin'],
    name: 'Oval Maple Tree Coffin',
    price: 750,
    images: ['product/coffin-modern-maple_ul9dp7.png'],
    colors: ['#B99374'],
    description: 'The Oval coffin has a more modern minimalist shape for coffin design, with its organic elliptical shape and delicate detailing. The soft sheen water-based lacquer emphasises the beautiful, rich, deep brown colour of the black American walnut, giving The Walnut Tree a feeling of comfort and calm.',
    brand: 'Astral',
    quantity: 3,
    rating: 5,
    createdAt: '2022-11-01T14:55:06.641+00:00',
  ...
  },
  {
    ...
    price: 445,
    images: ['/product/coffin-traditional-wreath-mould-lid_tbrfur.png'],
    colors: ['#B99374'],
  ...
  },
  {
    ...
    price: 425,
    images: ['/product/coffin-traditional-box-lid-coffin_ib0p8b.png'],
    colors: ['#B99374'],
    description: 'Traditional British Coffin hand crafted in the UK, from Quality oak veneer. Excellent finish, simple lines and classic design. Includes handles, coffin Liner and Name plate. All traditional coffins are available in the following Wood Stains: Dark Oak, Light Oak, Mahogony, Mid Oak, and Rose Click here to review all the wood stain colours we have to choose from',
    brand: 'Astral',
    quantity: 20,
  ...
  },
  {
    ...
    salePrice: 500,
    colors: ['#B99374'],
    images: ['/product/coffin-traditional-high-raised-lid-coffin_rzezsg.png'],
    brand: 'Astral',
    description: 'Traditional British Coffin hand crafted in the UK, from Quality oak veneer. Excellent finish, simple lines and classic design. Includes handles, coffin Liner and Name plate. All traditional coffins are available in the following Wood Stains: Dark Oak, Light Oak, Mahogony, Mid Oak, and Rose Click here to review all the wood stain colours we have to choose from',
    quantity: 6,
    rating: 3,
  ...
  },
  {
    ...
    colors: ['#f3eed7'],
    images: [
      '/product/shroud-bamboo_nptab1.png',
      '/product/shroud-bamboo-2_kgmrye.png',
      '/product/shroud-bamboo-3_vdti9v.png',
      '/product/coffin-willow-carrier_lvxuah.png',
      '/product/coffin-willow-carrier-2_eu6f3t.png',
    ],
  ...
  },
  {
    ...
    name: 'Simple Willow Coffin',
    price: 495,
    salePrice: 450,
    colors: ['#B99374'],
    images: ['/products/coffin-willow-simple_iy7nmw.png', '/products/coffin-willow-simple-2_wcdt50.png'],
  ...
  },
  {
    ...
    price: 415,
    colors: ['#f3eed7'],
    images: ['/product/coffin-willow-bamboo-round_wxvra2.png'],
  ...
  },
  {
    ...
    price: 485,
    colors: ['#f3eed7'],
    images: ['/product/coffin-willow-bamboo-lattice-round_yrifup.png'],
  ...
  },
  {
    ...
    price: 200,
    salePrice: 180,
    images: ['/product/coffin-child-wicker_phl14n.png', '/product/coffin-child-wicker-2_ix0dwp.png'],
    colors: ['#B99374'],
  ...
  },
  {
    ...
    price: 220,
    colors: ['#cfcdcb'],
    images: ['/product/coffin-child-curved-_painted_hqc7zr.png', '/product/coffin-child-curved-_painted-2_ipzcbc.png'],
  ...
  {
    categories: ['natural material coffin', 'baby coffin'],
    name: 'Baby Crib Casket',
    colors: ['#f3eed7'],
    price: 160,
    images: [
      '/product/coffin-baby-crib_jltf9j.png',
      '/product/coffin-baby-crib-2_oyqgil.png',
    ],
  ...
  {
    categories: ['natural material coffin', 'baby coffin'],
    name: 'Cane - Infant Coffin',
    colors: ['#f3eed7'],
    price: 450,
    images: ['/product/coffin-baby-cane_nnqji5.png',],
    description: 'Our Babies’ Caskets are gently handmade in either Seagrass, Banana Leaf or Cane. Rounded at both ends with straight sides and available in a range of sensitive sizes. Plaited loops and toggles and fully fitted with natural linings, pillow and covers as standard. Our babies caskets have the option of being finished with an oak engraved babies nameplate, which is smaller and much more suited to our babies’ caskets. In addition we can also provide smaller ashes caskets to match in Seagrass, Banana Leaf and Cane, each fitted with a drawstring cotton bag.',
    brand: 'Aurora',
    quantity: 10,
    rating: 3,
    createdAt: '2022-03-11T14:55:06.641+00:00',
  ...
  },
  {
    ...
    price: 65,
    colors: ['#B99374'],
    images: ['/product/cremation-urn1_dybjin.png'],
  ...
  },
  {
    ...
    price: 65,
    colors: ['#f3eed7'],
    images: ['/product/cremation-urn3_thv7jv.png'],
    description: 'Exclusive to Compare the Coffin. This cremation urn is beautifully made with natural BambooBamboo comes from a group of perennial evergreen plants in the grass family, and is the fastest growing plant in the world. Produced in a UK owned Fair Trade company in China. Made from 100% natural materials and 100% Bio-degradable. Includes natural cotton liner',
    brand: 'Aurora',
    quantity: 1,
    rating: 4,
  ...
  },
  {
    ...
    price: 65,
    images: ['/product/cremation-urn4_ds53na.png'],
    colors: ['#B99374'],
  ...
  },
  {
    ...
    price: 70,
    colors: ['#7A6255'],
    images: ['/product/cremation-urn5_m95gxq.png'],
    description: 'Exclusive to Compare the Coffin. This cremation urn is beautifully made with natural BambooBamboo comes from a group of perennial evergreen plants in the grass family, and is the fastest growing plant in the world. Produced in a UK owned Fair Trade company in China. Made from 100% natural materials and 100% Bio-degradable. Includes natural cotton liner',
    brand: 'Aurora',
    quantity: 1,
    rating: 4,
  ...
  },
  {
    ...
    price: 65,
    colors: ['#f3eed7'],
    images: ['/product/cremation-urn6_ggztgv.png'],
    description: 'Exclusive to Compare the Coffin. This cremation urn is beautifully made with natural BambooBamboo comes from a group of perennial evergreen plants in the grass family, and is the fastest growing plant in the world. Produced in a UK owned Fair Trade company in China. Made from 100% natural materials and 100% Bio-degradable. Includes natural cotton liner',
    brand: 'Astral',
    quantity: 2,
    rating: 3,
  ...
  },
  {
    ...
    price: 750,
    colors: ['#B99374'],
    images: ['/product/coffin-willow-buff-rounded_pn6ksx.png'],
  ...
  },
  {
    ...
    price: 505,
    colors: ['#f3eed7'],
    images: ['/product/coffin-willow-rounded_noggwl.png'],
  ...
  },
  {
    ...
    price: 475,
    colors: ['#B99374'],
    images: ['/product/shroud1_uc4ex5.png'],
  ...
  },
  {
    ...
    price: 220,
    salePrice: 198.32,
    images: ['/product/coffin-willow-gold_to6orf.png', '/product/coffin-willow-gold-2_lw5m49.png'],
    colors: ['#B99374'],
  ...
  },
  {
    ...
    price: 290,
    salePrice: 280,
    images: ['product/coffin-willow-cane_o85vh2.png', '/product/coffin-willow-cane-2_lmiirr.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 270,
    salePrice: 200,
    images: ['/product/coffin-willow-seagrass_mlb0oo.png', '/product/coffin-willow-seagrass-2_b7u4wl.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 182,
    salePrice: 150.4,
    images: ['/product/coffin-baby-banana-leaf_ayapfe.png', '/product/coffin-baby-banana-leaf-2_ao7pq4.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 220,
    salePrice: 202.5,
    images: ['/product/coffin-willow-bamboo_ptekwa.png', '/product/coffin-willow-bamboo-2_n0fklv.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 543,
    salePrice: null,
    images: ['/product/coffin-willow-banana-leaf-curved_cep9jy.png', '/product/coffin-willow-banana-leaf-curved-2_cienyq.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 700,
    salePrice: null,
    images: ['/product/coffin-willow-white-wicker_d9ywd9.png', '/product/coffin-willow-white-wicker-2_vadzjz.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 700,
    salePrice: null,
    images: ['/product/coffin-willow-round-ended_itcvff.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 700,
    salePrice: null,
    images: ['/product/coffin-willow-somerset_nhza4g.png', '/product/coffin-willow-somerset-2_o8903e.png'],
    colors: ['#f3eed7'],
    ...
    quantity: 4,
    rating: 5,
    createdAt: '2022-10-11T14:55:06.641+00:00',
    bestSelling: true
  },
  {
    categories: ['natural material coffin', 'child coffin'],
    ...
    price: 680,
    salePrice: null,
    images: ['/product/coffin-willow-water-hyacinth_kf40j1.png'],
    colors: ['#f3eed7'],
  ...
  },
  {
    ...
    price: 199,
    colors: ['#B99374'],
    images: ['/product/urn-black-modern_hzizhb.png',
      '/product/urn-black-modern-2_blijrk.png',
    ],
  ...
  },
  {
    ...
    price: 349,
    colors: ['#f3eed7'],
    images: ['/product/coffin-willow-carrier_lvxuah.png',
      '/product/coffin-willow-carrier-2_eu6f3t.png',
    ],
    description: 'Passages shrouds are suitable for burial or cremation, and are 100% biodegradable. They can be used as an eco-friendly and unique alternative to clothing for use in a Wicker Casket or Willow Carrier. To simplify the movement and transport of a shrouded body, we recommend using our Willow Carrier with all shrouded burials or cremations.',
    brand: 'Aurora',
  ...
  },
  {
    ...
    price: 795,
    colors: ['#B99374'],
    images: ['/product/coffin-traditional-premium-casket_xgtzvr.png'],
  ...
  },
  {
    ...
    price: 1500,
    colors: ['#f3eed7'],
    images: ['/product/memorial-lawn_oq7xjw.png'],
  ...
  },
  {
    ...
    price: 4940,
    colors: ['#f3eed7'],
    images: ['/product/memorial-mother-and-child_k4pkae.png',],
  ...
  },
  {
    ...
    price: 1610,
    colors: ['#f3eed7'],
    images: ['/product/memorial-headstone-with-cross_ij5jjx.png',],
  ...
  },
  {
    ...
    price: 5752,
    colors: ['#f3eed7'],
    images: ['/product/memorial-sacred-heart-gate_qlxxgr.png',],
