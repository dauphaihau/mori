          ...
          {data.resources.map((resource, index) => {
            return (
              ...
              >
                ...
                <a
                  href={resource.link}
                  className="h-full w-full aspect-square block absolute top-0 left-0 transition-opacity duration-300 opacity-0 hover:opacity-100 bg-gray-800/75 z-10"
                >
